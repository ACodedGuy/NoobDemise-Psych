	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				case 1:
					#if PSYCH_WATERMARKS
					createCoolText(['Noob Demise Mod by'], 15);
					#else
					createCoolText(['AllisonCoding', 'Switch', 'Synthic', 'Sinwalker']);
					#end
				// credTextShit.visible = true;
				case 3:
					#if PSYCH_WATERMARKS
					addMoreText('AllisonCoding', 15);
					addMoreText('Switch', 15);
					addMoreText('Synthic', 15);
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
				...
				case 5:
					#if PSYCH_WATERMARKS
					createCoolText(['Bloxxin X Funkin Mod by', 'AbraX'], -40);
					#else
					createCoolText(['In association', 'with'], -40);
					#end
				case 7:
					addMoreText('Himself', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 8:
					deleteCoolText();
				...
				// credTextShit.screenCenter();
				case 13:
					addMoreText('Bloxxin X Funkin');
				// credTextShit.visible = true;
				case 14:
					addMoreText('Noobs Demise');
				// credTextShit.text += '\nNight';
				case 15:
